...
final class Constants {
    ...
    static final int STATE_OK       = 11;
    static final int STATE_UPDATING = 12;
    static final int STATE_ERROR    = 13;

    static final int SUCCESS_RESULT = 0;

    static final int FAILURE_RESULT = 1;

    private static final String PACKAGE_NAME = "com.softlutions.hv12.reversegeocodertest";
